...
fabric-ca-client register --caname ca-registry --id.name peer1 --id.secret peer1pw --id.type peer --tls.certfiles ${PWD}/organizations/fabric-ca/registry/tls-cert.pem
mkdir -p organizations/peerOrganizations/registry.node.connection/peers/peer1.registry.node.connection
fabric-ca-client enroll -u https://peer1:peer1pw@localhost:7054 --caname ca-registry -M ${PWD}/organizations/peerOrganizations/registry.node.connection/peers/peer1.registry.node.connection/msp --csr.hosts peer1.registry.node.connection --tls.certfiles ${PWD}/organizations/fabric-ca/registry/tls-cert.pem
...
fabric-ca-client enroll -u https://peer1:peer1pw@localhost:7054 --caname ca-registry -M ${PWD}/organizations/peerOrganizations/registry.node.connection/peers/peer1.registry.node.connection/tls --enrollment.profile tls --csr.hosts peer1.registry.node.connection --csr.hosts localhost --tls.certfiles ${PWD}/organizations/fabric-ca/registry/tls-cert.pem
